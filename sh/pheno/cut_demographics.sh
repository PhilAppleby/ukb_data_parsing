...
#
python ${PYDIR}/cut_main_csv_file.py --csvfile=${UKBDATADIR}/ukb9888.csv --colprefs=21022,52,34,31,189 > /home/pda11181/devel/data/ukb_baseline_demographic_data.csv
