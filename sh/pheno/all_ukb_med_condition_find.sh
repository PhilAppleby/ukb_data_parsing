...
${SHDIR}/grep_from_file.sh ${MDATADIR}/${1}/med_list_codes.txt ${MDATADIR}/medication_data_normalised.csv > ${MDATADIR}/${1}/medication_data.csv

cut -f 1 -d ',' ${MDATADIR}/${1}/medication_data.csv | sort -u > ${MDATADIR}/${1}/all_participants_taking_listed_drugs.txt
